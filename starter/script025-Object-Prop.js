...
// en allant à chaque fois rechercher les propriétés dans l'objet 'moi' que tu viens de créer
moi.profession = "Web Designer";
moi.age = 24;
moi.situation = "marié";
console.log(moi);
console.log(`Je m'appelle ${moi.prenom} ${moi.nom}, j'ai ${moi.age} ans, je suis ${moi.nationalite}, je suis ${moi.profession} et je suis ${moi.situation}`);
